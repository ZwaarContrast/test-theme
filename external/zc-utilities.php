 ...
 * The main one that is used in Starkers is ZC_Utilities::add_slug_to_body_class(), this will add the page or post slug to the body class
 *
 */
 ...
 class ZC_Utilities {
	 ...
	 * e.g. ZC_Utilities::get_page_id_from_path('about/terms-and-conditions');
	 *
	 * @param 	string 
	 * @return 	integer
	 * @author 	Keir Whitaker
    ...
    public static function check_user_role( $role, $user_id = null ) {
        //Check if user id supplied is numeric
        ...
        //Return false on empty user object
        if ( empty( $user ) )
            return false;
        
        //Return wether or not the supplied role is present in user object
